...
function CalcNewTemp() {
	...
	balloonTemp = balloonTemp + (propaneEnergy*(steplength)/(airDensity*balloonVolume*specificHeatCapacity_Air));  //En gasbrännare 3-4MW
	...
	if(parachuteVentOpen){
		...
		balloonTemp = (balloonTemp*(balloonVolume-airFlow*(steplength)) + airTemp*airFlow*(steplength))/balloonVolume;
	}
